...
static GBitmap *s_res_action_previous_icon;
static GBitmap *s_res_action_refresh_icon;
static GBitmap *s_res_action_next_icon;
...
static void initialise_ui(void) {
  ...
  s_res_action_previous_icon = gbitmap_create_with_resource(RESOURCE_ID_ACTION_PREVIOUS_ICON);
  s_res_action_refresh_icon = gbitmap_create_with_resource(RESOURCE_ID_ACTION_REFRESH_ICON);
  s_res_action_next_icon = gbitmap_create_with_resource(RESOURCE_ID_ACTION_NEXT_ICON);
  ...
  action_bar_layer_set_icon(actionbar_layer, BUTTON_ID_UP, s_res_action_previous_icon);
  action_bar_layer_set_icon(actionbar_layer, BUTTON_ID_SELECT, s_res_action_refresh_icon);
  action_bar_layer_set_icon(actionbar_layer, BUTTON_ID_DOWN, s_res_action_next_icon);
  ...
  text_layer_set_text(textlayer_debug, "Text layer");
...
static void destroy_ui(void) {
  ...
  gbitmap_destroy(s_res_action_previous_icon);
  gbitmap_destroy(s_res_action_refresh_icon);
  gbitmap_destroy(s_res_action_next_icon);
}
