 ...
 */
class SwipeMoveFavouriteCallback(context: Context, callback: ISwipeCallback) :
    SwipeFavouriteCallback(context, callback, ItemTouchHelper.UP or ItemTouchHelper.DOWN) {
