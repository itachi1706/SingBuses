 ...
 */
open class SwipeFavouriteCallback(
    var context: Context,
    var callback: ISwipeCallback,
    dragDir: Int = 0
) :
    ...
    private val unfavouriteBitmap: Bitmap =
        BitmapUtil.getBitmap(context, R.drawable.ic_favourte_off)!!
    private val iconColor: Paint = Paint().apply {
        color = Color.WHITE; colorFilter =
    ...
    override fun onChildDraw(
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            ...
            val swipeDirection =
                if (dX > 0) ItemTouchHelper.RIGHT else if (dX < 0) ItemTouchHelper.LEFT else ItemTouchHelper.UP
